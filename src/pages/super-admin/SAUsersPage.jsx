...
import { Button, Card, Col, Row, Table, Badge, Modal, Form, InputGroup } from "react-bootstrap";
                    ...
                    <Form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div className="p-3 mb-4 rounded-4 bg-light border-0 d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <span className="text-muted small">Los usuarios inactivos no podrán iniciar sesión.</span>
                            </div>
                            <Form.Check 
                                type="switch"
