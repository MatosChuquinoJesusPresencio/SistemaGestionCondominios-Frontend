                ...
                <div className="card border-0 shadow-lg position-relative p-4 rounded-4 login-glass-card login-card-container">
                    ...
                    {!isSubmitted ? (
                        <form noValidate onSubmit={handleSubmit(onSubmit)}>
                            ...
                            {authError && (
                                <div className="alert alert-danger d-flex align-items-center justify-content-center position-relative mt-1 py-2 border-0 rounded-3 shadow-sm text-center">
