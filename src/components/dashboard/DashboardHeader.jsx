const DashboardHeader = ({ icon: Icon, title, badgeText, welcomeText, children }) => {
    return (
        <div className="row mb-5 align-items-center">
            <div className="col-12 col-md-8">
                ...
                <p className="text-muted mb-0 ms-1 d-flex align-items-center gap-2">
                    <span className="badge bg-primary bg-opacity-10 text-primary border border-primary border-opacity-10 px-2 py-1 rounded-1 small">{badgeText}</span>
